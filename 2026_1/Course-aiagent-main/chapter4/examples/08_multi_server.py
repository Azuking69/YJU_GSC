"""
Chapter 4-8: 다중 MCP 서버 연결

실제 Agent는 여러 MCP 서버에 동시에 연결해
분야별로 나뉜 도구를 함께 사용할 수 있습니다.

이 예제의 구성:
    서버 A: 메모장 (06_components_server.py) - Tool/Resource/Prompt
    서버 B: 파일시스템 (08_multi_server_file.py) - Tool만
...
실행:
    python chapter4/examples/08_multi_server.py
"""
...
SERVERS = {
    "notes": str(BASE / "06_components_server.py"),
    "files": str(BASE / "08_multi_server_file.py"),
}
...
async def main():
    print("=" * 70)
    print(" Chapter 4-8: 다중 MCP 서버 연결")
    print("=" * 70)
