"""
Chapter 4-6: MCP 3대 구성요소 클라이언트 (Resource / Tool / Prompt)

06_components_server.py에 연결해 세 구성요소를 직접 호출하고,
...
실행:
    python chapter4/examples/06_components_client.py
"""
...
SERVER_PATH = str(Path(__file__).parent / "06_components_server.py")
...
async def main():
    print("=" * 70)
    print(" Chapter 4-6: 3대 구성요소 직접 호출")
    print("=" * 70)
