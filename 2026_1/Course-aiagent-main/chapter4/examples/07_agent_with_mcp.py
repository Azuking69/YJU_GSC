"""
Chapter 4-7: MCP 3대 구성요소 + LLM 결합 Agent

06_components_server.py의 Resource/Tool/Prompt를
...
실행:
    python chapter4/examples/07_agent_with_mcp.py
"""
...
async def main():
    print("=" * 70)
    print(" Chapter 4-7: MCP 3대 구성요소 + LLM Agent")
    print("=" * 70)
    print("""
  입력 방식:
